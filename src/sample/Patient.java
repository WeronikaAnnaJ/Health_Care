...
public class Patient extends  Person{
    ...
    private static Patient patientExample;

    static {
        try {
            patientExample = new Patient("Weronika","Elwira",null, "Kowalska", "999", LocalDate.of(1990,2,10), "400344500", "elwira.kowalska@gmail.com");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
